...
import BarraContactosSkeleton from "./skeletons/BarraContactosSkeleton";
...
const BarraContactos = () => {
    ...
    if (isUsersLoading) return <BarraContactosSkeleton />;
            ...
            <div className="border-b border-base-300 w-full p-5">
                ...
                <div className="mt-3 hidden lg:flex items-center gap-2">
                    <label className="cursor-pointer flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm">Mostrar solo contactos Online</span>
                    </label>
            ...
            <div className="overflow-y-auto w-full py-3">
              ...
              `}
                ...
                {filteredUsers.length === 0 && (
                    <div className="text-center text-zinc-500 py-4">No hay usuarios online</div>
                )}
            </div>
        </aside>
    );
